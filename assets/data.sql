...
INSERT INTO trips (information, type, price, cost_type, date, time) VALUES
('Fishing trip in the Mediterranean Sea', 'Fishing', 150.00, 'Per Person', '2024-12-01', '08:00:00'),
('Sightseeing tour along the coast', 'Tourism', 200.00, 'Per Person', '2024-12-02', '10:00:00'),
('River fishing adventure', 'Fishing', 120.00, 'Per Person', '2024-12-03', '09:00:00');

-- Insertion des logs de pêche
INSERT INTO fishing_logs (fish_name, picture, comment, height, weight) VALUES
('Tuna', 'tuna.jpg', 'Caught a big tuna!', 80, 200),
('Salmon', 'salmon.jpg', 'Great catch!', 60, 150),
('Bass', 'bass.jpg', 'Caught a nice bass', 50, 120),
('Trout', 'trout.jpg', 'Caught a great trout', 40, 100),
('Perch', 'perch.jpg', 'Nice size perch caught!', 30, 80);
